...
#    - Remember to call the factory when applying the decorator
#===============================================================================
...
def add_str_decorator(cls):
    """Decorator to add the __str__ magic method
    """
    class Wrapped(cls):  # We inherit from the decorated class
        def __str__(self):
            return "{} instance @ {}".format(cls.__name__, id(self))
    return Wrapped
...
new_dummy_instance = DummyClass()
print new_dummy_instance


#===============================================================================
# - Classes are first-class objects too, so we can decorate classes too
#    - The decorator must return a new class
#    - All the previous decorators examples could be reused too
# - I personally would rather use metaclasses instead of classes decorators
#===============================================================================
...
#===============================================================================
# EXERCISE: exercises/mod_04_advanced_decorators/exercise_mod_04.py
#
